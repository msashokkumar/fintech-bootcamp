...
print(f"Total loan amount: {sum_of_loans}")

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount

# Average Loan Price = Sum of Loans Price/ Number of Loans
...
remaining_months_on_loan  = loan.get("remaining_months")

print(f"Loan future value: {loan_future_value}")
print(f"Remaining months on loan: {remaining_months_on_loan}")
...
with open ("inexpensive_loans.csv", 'w') as csvfile:
    ...
    for i_loan in inexpensive_loans:
        csvwriter.writerow(i_loan.values())
